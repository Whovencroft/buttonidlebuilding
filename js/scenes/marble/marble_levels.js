...
function sampleSupportSurface(level, x, y, radius = 0.18, clearance = 0.72, options = {}) {
  ...
  function buildGentleSlopes() {
    ...
    // Ramp from flat at x=13 (height 6) down to flat at x=20 (height 4): 6 tiles, rise=1/3
    setSurface(level, 14, 28, { baseHeight: 5.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 15, 28, { baseHeight: 5.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 16, 28, { baseHeight: 5.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 28, { baseHeight: 4.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 28, { baseHeight: 4.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 28, { baseHeight: 4.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 14, 29, { baseHeight: 5.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 15, 29, { baseHeight: 5.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 16, 29, { baseHeight: 5.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 29, { baseHeight: 4.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 29, { baseHeight: 4.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 29, { baseHeight: 4.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 14, 30, { baseHeight: 5.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 15, 30, { baseHeight: 5.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 16, 30, { baseHeight: 5.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 30, { baseHeight: 4.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 30, { baseHeight: 4.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 30, { baseHeight: 4.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 14, 31, { baseHeight: 5.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 15, 31, { baseHeight: 5.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 16, 31, { baseHeight: 5.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 31, { baseHeight: 4.667, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 31, { baseHeight: 4.333, shape: 'slope_w', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 31, { baseHeight: 4.0, shape: 'slope_w', rise: 0.333, kind: 'track' });
    ...
    // Ramp from flat at y=31 (height 4) down to flat at y=39 (height 2): 7 tiles, rise=2/7≈0.2857
    setSurface(level, 36, 32, { baseHeight: 3.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 33, { baseHeight: 3.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 34, { baseHeight: 3.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 35, { baseHeight: 2.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 36, { baseHeight: 2.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 37, { baseHeight: 2.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 36, 38, { baseHeight: 2.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 32, { baseHeight: 3.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 33, { baseHeight: 3.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 34, { baseHeight: 3.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 35, { baseHeight: 2.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 36, { baseHeight: 2.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 37, { baseHeight: 2.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 37, 38, { baseHeight: 2.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 32, { baseHeight: 3.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 33, { baseHeight: 3.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 34, { baseHeight: 3.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 35, { baseHeight: 2.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 36, { baseHeight: 2.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 37, { baseHeight: 2.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 38, 38, { baseHeight: 2.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 32, { baseHeight: 3.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 33, { baseHeight: 3.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 34, { baseHeight: 3.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 35, { baseHeight: 2.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 36, { baseHeight: 2.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 37, { baseHeight: 2.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 39, 38, { baseHeight: 2.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    // Ramp from flat at y=43 (height 2) down to flat at y=51 (height 0): 7 tiles, rise=2/7≈0.286
    setSurface(level, 28, 44, { baseHeight: 1.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 45, { baseHeight: 1.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 46, { baseHeight: 1.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 47, { baseHeight: 0.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 48, { baseHeight: 0.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 49, { baseHeight: 0.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 28, 50, { baseHeight: 0.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 44, { baseHeight: 1.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 45, { baseHeight: 1.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 46, { baseHeight: 1.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 47, { baseHeight: 0.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 48, { baseHeight: 0.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 49, { baseHeight: 0.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 29, 50, { baseHeight: 0.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 44, { baseHeight: 1.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 45, { baseHeight: 1.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 46, { baseHeight: 1.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 47, { baseHeight: 0.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 48, { baseHeight: 0.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 49, { baseHeight: 0.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 30, 50, { baseHeight: 0.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 44, { baseHeight: 1.714, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 45, { baseHeight: 1.429, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 46, { baseHeight: 1.143, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 47, { baseHeight: 0.857, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 48, { baseHeight: 0.571, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 49, { baseHeight: 0.286, shape: 'slope_n', rise: 0.286, kind: 'track' });
    setSurface(level, 31, 50, { baseHeight: 0.0, shape: 'slope_n', rise: 0.286, kind: 'track' });
  ...
  function buildForkedPath() {
    ...
    setSurface(level, 43, 37, { baseHeight: 4.25, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 44, 37, { baseHeight: 3.5, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 45, 37, { baseHeight: 2.75, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 46, 37, { baseHeight: 2.0, shape: 'slope_w', rise: 0.75, kind: 'track' });
    ...
    setSurface(level, 43, 38, { baseHeight: 4.25, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 44, 38, { baseHeight: 3.5, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 45, 38, { baseHeight: 2.75, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 46, 38, { baseHeight: 2.0, shape: 'slope_w', rise: 0.75, kind: 'track' });
    ...
    // Ramp y=39, x=43-46: slope_w from 5 down to 2, 4 tiles, rise=0.75
    setSurface(level, 43, 39, { baseHeight: 4.25, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 44, 39, { baseHeight: 3.5, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 45, 39, { baseHeight: 2.75, shape: 'slope_w', rise: 0.75, kind: 'track' });
    setSurface(level, 46, 39, { baseHeight: 2.0, shape: 'slope_w', rise: 0.75, kind: 'track' });
    ...
    // Ramp x=45, y=15-17: slope_s from 2 up to 4, 3 tiles, rise=0.667
    setSurface(level, 45, 15, { baseHeight: 2.0, shape: 'slope_s', rise: 0.667, kind: 'track' });
    setSurface(level, 45, 16, { baseHeight: 2.667, shape: 'slope_s', rise: 0.667, kind: 'track' });
    setSurface(level, 45, 17, { baseHeight: 3.333, shape: 'slope_s', rise: 0.667, kind: 'track' });
    setSurface(level, 46, 15, { baseHeight: 2.0, shape: 'slope_s', rise: 0.667, kind: 'track' });
    setSurface(level, 46, 16, { baseHeight: 2.667, shape: 'slope_s', rise: 0.667, kind: 'track' });
    setSurface(level, 46, 17, { baseHeight: 3.333, shape: 'slope_s', rise: 0.667, kind: 'track' });
    // Ramp x=17, y=20-23: slope_s from 8 up to 10, 4 tiles, rise=0.5
    setSurface(level, 17, 20, { baseHeight: 8.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 17, 21, { baseHeight: 8.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 17, 22, { baseHeight: 9.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 17, 23, { baseHeight: 9.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 18, 20, { baseHeight: 8.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 18, 21, { baseHeight: 8.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 18, 22, { baseHeight: 9.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 18, 23, { baseHeight: 9.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 19, 20, { baseHeight: 8.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 19, 21, { baseHeight: 8.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 19, 22, { baseHeight: 9.0, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 19, 23, { baseHeight: 9.5, shape: 'slope_s', rise: 0.5, kind: 'track' });
    setSurface(level, 38, 33, { baseHeight: 4.0, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 38, 34, { baseHeight: 4.25, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 38, 35, { baseHeight: 4.5, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 38, 36, { baseHeight: 4.75, shape: 'slope_s', rise: 0.25, kind: 'track' });
    // Ramp x=39, y=33-36: slope_s from 4 up to 5, 4 tiles, rise=0.25
    setSurface(level, 39, 33, { baseHeight: 4.0, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 39, 34, { baseHeight: 4.25, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 39, 35, { baseHeight: 4.5, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 39, 36, { baseHeight: 4.75, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 40, 33, { baseHeight: 4.0, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 40, 34, { baseHeight: 4.25, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 40, 35, { baseHeight: 4.5, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 40, 36, { baseHeight: 4.75, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 41, 33, { baseHeight: 4.0, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 41, 34, { baseHeight: 4.25, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 41, 35, { baseHeight: 4.5, shape: 'slope_s', rise: 0.25, kind: 'track' });
    setSurface(level, 41, 36, { baseHeight: 4.75, shape: 'slope_s', rise: 0.25, kind: 'track' });
    // Ramp x=45, y=28-32: slope_n from 4 down to 2, 5 tiles, rise=0.4
    setSurface(level, 45, 28, { baseHeight: 3.6, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 45, 29, { baseHeight: 3.2, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 45, 30, { baseHeight: 2.8, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 45, 31, { baseHeight: 2.4, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 45, 32, { baseHeight: 2.0, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 46, 28, { baseHeight: 3.6, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 46, 29, { baseHeight: 3.2, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 46, 30, { baseHeight: 2.8, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 46, 31, { baseHeight: 2.4, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 46, 32, { baseHeight: 2.0, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 47, 28, { baseHeight: 3.6, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 47, 29, { baseHeight: 3.2, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 47, 30, { baseHeight: 2.8, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 47, 31, { baseHeight: 2.4, shape: 'slope_n', rise: 0.4, kind: 'track' });
    setSurface(level, 47, 32, { baseHeight: 2.0, shape: 'slope_n', rise: 0.4, kind: 'track' });
    // Ramp x=17, y=34-36: slope_n from 10 down to 9, 3 tiles, rise=1/3
    setSurface(level, 17, 34, { baseHeight: 9.667, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 35, { baseHeight: 9.333, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 17, 36, { baseHeight: 9.0, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 34, { baseHeight: 9.667, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 35, { baseHeight: 9.333, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 18, 36, { baseHeight: 9.0, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 34, { baseHeight: 9.667, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 35, { baseHeight: 9.333, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 19, 36, { baseHeight: 9.0, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 20, 34, { baseHeight: 9.667, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 20, 35, { baseHeight: 9.333, shape: 'slope_n', rise: 0.333, kind: 'track' });
    setSurface(level, 20, 36, { baseHeight: 9.0, shape: 'slope_n', rise: 0.333, kind: 'track' });
  ...
  function buildCrumbleBridge() {
    ...
    // Ramp x=19, y=45-47: slope_n from 6 down to 4, 3 tiles, rise=0.667
    setSurface(level, 19, 45, { baseHeight: 5.333, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 19, 46, { baseHeight: 4.667, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 19, 47, { baseHeight: 4.0, shape: 'slope_n', rise: 0.667, kind: 'track' });
    ...
    setSurface(level, 20, 45, { baseHeight: 5.333, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 20, 46, { baseHeight: 4.667, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 20, 47, { baseHeight: 4.0, shape: 'slope_n', rise: 0.667, kind: 'track' });
    ...
    setSurface(level, 21, 45, { baseHeight: 5.333, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 21, 46, { baseHeight: 4.667, shape: 'slope_n', rise: 0.667, kind: 'track' });
    setSurface(level, 21, 47, { baseHeight: 4.0, shape: 'slope_n', rise: 0.667, kind: 'track' });
    // Crumble tiles
  ...
  function buildTheFinalAscent() {
    ...
    addMovingBridge(level, 'plat1', [
      ...
      { x: 3.5, y: 40.5, z: 6 },
      { x: 3.5, y: 53.5, z: 2 },
    ], 2, 2, 0.22, { pauseDuration: 1.5, midpointPause: 0.5 });
